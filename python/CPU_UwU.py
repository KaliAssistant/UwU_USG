...
class CircularProgress(QWidget):
    ...
    def updateTimeline(self, frame):
        ...
        self.per_num = int(psutil.cpu_percent(interval=0))
    ...
    def timerEvent(self, event):
        ...
        self.angle = int(psutil.cpu_percent(interval=0)*3.6)  # self.input.value()
    ...
    def setAngle(self):
        self.drawAngle = self.angle
        self.angle =int(psutil.cpu_percent()) #self.input.value()
        #self.timeLine.stop()
        self.timeLine.setFrameRange(self.drawAngle, self.angle)
        self.update()
        self.timeLine.start()
